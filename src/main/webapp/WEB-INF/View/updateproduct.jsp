...
<head>
    ...
    <link rel="icon" type="image/png" href="addimages/shopping-bag.png"/>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="number" name="first_name">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Product weight(G)</label>
